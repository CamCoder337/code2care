...
export default function HomePage() {
  const { isAuthenticated, isLoading, redirectToRoleDashboard } = useUnifiedAuth()
  ...
  }, [isAuthenticated, isLoading, redirectToRoleDashboard])
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <header className="border-b border-border/40 backdrop-blur-sm bg-background/98 dark:bg-background/95 sticky top-0 z-50">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="header-nav flex items-center gap-3">
              <Link href="/login" passHref>
                <Button variant="outline" size="sm" className="hidden sm:flex border-blue-200 hover:border-blue-300 hover:bg-blue-50 dark:border-blue-800 dark:hover:border-blue-700 dark:hover:bg-blue-900/20">
      ...
      <main className="flex-grow">
        ...
        <section ref={heroRef} className="hero-section container mx-auto px-4 py-16 text-center">
          ...
          <p className="hero-subtitle text-lg md:text-xl text-muted-foreground mb-10 max-w-3xl mx-auto">
            Plateforme médicale innovante pour une meilleure collaboration entre patients et professionnels de santé
          </p>

          <div className="hero-button flex flex-col sm:flex-row justify-center items-center gap-4">
            <Link href="/login" passHref>
              <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 shine-effect">
        ...
        <section ref={featuresRef} className="bg-white/60 dark:bg-gray-800/80 py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Espace Patient */}
              <div className="feature-card glow-on-hover bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/40 dark:to-indigo-900/40 p-8 rounded-2xl border border-blue-200/50 dark:border-blue-800/70 hover:shadow-lg transition-all duration-300 hover:scale-[1.02]">
                <div className="floating-icon w-16 h-16 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl flex items-center justify-center mb-6">
              ...
              <div className="feature-card glow-on-hover bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/40 dark:to-emerald-900/40 p-8 rounded-2xl border border-green-200/50 dark:border-green-800/70 hover:shadow-lg transition-all duration-300 hover:scale-[1.02]">
                <div className="floating-icon w-16 h-16 bg-gradient-to-r from-green-500 to-green-600 rounded-xl flex items-center justify-center mb-6">
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {[
                ...
                <div key={index} className="language-badge glow-on-hover bg-white/70 dark:bg-gray-800/90 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/70 rounded-lg p-4 text-center hover:shadow-md transition-all duration-300 hover:scale-105 cursor-pointer">
        ...
        {/* CTA Section */}
        <section ref={ctaRef} className="bg-gradient-to-r from-blue-600 via-green-600 to-blue-800 py-16 overflow-hidden relative">
          <div className="absolute inset-0 opacity-50">
            <div className="animated-bg absolute inset-0 bg-gradient-to-r from-blue-400 via-purple-500 to-green-500"></div>
          </div>
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="cta-content">
              ...
              <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
                Rejoignez HIGH5 Medical pour une communication plus efficace entre patients et professionnels de santé
              </p>
              <Link href="/login" passHref>
                <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100 hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-xl">
                  <User className="mr-2 h-5 w-5" />
